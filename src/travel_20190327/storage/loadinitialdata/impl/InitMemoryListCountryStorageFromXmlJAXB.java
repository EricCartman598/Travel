...
import travel_20190327.storage.loadinitialdata.xjc.City;
import travel_20190327.storage.loadinitialdata.xjc.Country;
import travel_20190327.storage.loadinitialdata.xjc.InitData;
    ...
    private List<BaseCountry> convertJaxbClassesToDomainClasses(InitData initData) {
        ...
        for (Country country : initData.getCountries().getCountry()) {
            ...
            for(City city : country.getCities().getCity()) {
                travel_20190327.city.domain.City importedCity = new travel_20190327.city.domain.City();
