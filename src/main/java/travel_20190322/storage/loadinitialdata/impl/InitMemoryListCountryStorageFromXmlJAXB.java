...
import main.java.travel_20190322.storage.loadinitialdata.xjc.City;
import main.java.travel_20190322.storage.loadinitialdata.xjc.Country;
import main.java.travel_20190322.storage.loadinitialdata.xjc.Discriminator;
import main.java.travel_20190322.storage.loadinitialdata.xjc.InitData;
    ...
    private List<BaseCountry> convertJaxbClassesToDomainClasses(InitData initData) {
        ...
        for (Country country : initData.getCountries().getCountry()) {
            ...
            for(City city : country.getCities().getCity()) {
                main.java.travel_20190322.city.domain.City importedCity = new main.java.travel_20190322.city.domain.City();
